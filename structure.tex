...
\usepackage[unicode=true, colorlinks=true, citecolor=my_green_d, urlcolor=my_blue_d, linkcolor=my_blue_d]{hyperref}
\setcounter{secnumdepth}{0} % Suppress section numbering

\usepackage{sectsty} % Allows customization of titles
\sectionfont{\roboto\bfseries\color{my_blue_d}} % Roboto bold blue section titles
...
\DeclareBibliographyDriver{article}{%
  ...
  \iffieldundef{citations}
    {}
    {\adddot\addspace\printfield{citations}}%
  \finentry
}
